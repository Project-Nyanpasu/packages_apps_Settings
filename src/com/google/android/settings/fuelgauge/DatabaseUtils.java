    ...
    public static List<ContentValues> sendBatteryEntryData(
        ...
        if (list != null) {
            list.stream().filter(batteryEntry -> {
                ...
                return batteryEntry.getConsumedPower() != 0.0d || timeInForegroundMs != 0 || timeInBackgroundMs != 0;
